...
#define UCUNIT_LogString(msg)    System_LogString(msg)
/**
...
#define UCUNIT_WritePassedMsg(msg, args)                        \
    ...
    {                                                           \
        ...
        UCUNIT_LogString(":");                                \
        UCUNIT_LogString(UCUNIT_DefineToString(__LINE__));    \
        UCUNIT_LogString(":passed:");                        \
        UCUNIT_LogString(msg);                                \
        UCUNIT_LogString("(");                                \
        UCUNIT_LogString(args);                               \
        UCUNIT_LogString(")");                              \
    } while(0)
#else
#define UCUNIT_WritePassedMsg(msg, args)
